...
RSpec.describe 'admin shelters index page' do
  ...
  it 'lists shelters with pending applications alphabetically' do
    pet_1 = Pet.create!(adoptable: true, age: 2, breed: 'Bulldog', name: 'Butch', shelter_id: @shelter_2.id)
    pet_2 = Pet.create!(adoptable: true, age: 1, breed: 'German Shpherd', name: 'Sandy', shelter_id: @shelter_3.id)
